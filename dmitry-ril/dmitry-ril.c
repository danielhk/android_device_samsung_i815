...
#define REAL_RIL_NAME				"/system/lib/libsec-ril_lte.so"
...
const RIL_RadioFunctions* RIL_Init(const struct RIL_Env *env, int argc, char **argv)
{
	...
	RLOGI("RIL interposition library by me@dmitry.gr loaded\n");
	ALOGI("RIL interposition library by me@dmitry.gr loaded\n");
